...
# Dump of table xxl_job_alarm_info
# ------------------------------------------------------------
...
# Dump of table xxl_job_alarm_log
# ------------------------------------------------------------
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='job任务调度锁';
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='job调度日志';
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='job报表';
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='xxl_job_logglue';
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='job 注册信息';



# Dump of table xxl_job_schedule_config
# ------------------------------------------------------------
